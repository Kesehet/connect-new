...
<html>
    ...
    <body bgcolor="#e3e8e3">
        ...
        <table cellpadding="0" cellspacing="0" style="max-width: 602px; width: 100%;" align="center">
            ...
            <tr>
                <td style="background-color: #5c9ead; padding: 15px;" align="center" valign="middle">
                    <a href="#"><img src="https://thinknyx.com/wp-content/uploads/2020/03/logo_thinknyx.png" width="200px" height="48px"></a>
                </td>
            </tr>

            <tr>
                <td style="background-color:#25abe1; padding: 100px 30px; background-image:linear-gradient(rgba(0,0,0,0.2),rgba(0,0,0,0.2)), url('https://cdn.pixabay.com/photo/2018/04/28/16/27/energy-3357613_960_720.jpg'); background-size: cover; background-position: center;" align="center" valign="middle">
            ...
            <tr>
                <td align="center" valign="top">
                    <table cellpadding="0" cellspacing="0" style="width: 100%; background-color: #5c9ead">
                        <tr>
                            <td valign="middle">
                                <div style="display: block;width: 100%;height: 1px;background-color: #5c9ead"></div>
                            </td>
                        </tr>
                        <tr>
