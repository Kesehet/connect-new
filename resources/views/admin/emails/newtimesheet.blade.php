                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 100%; background-color: #afccdb">
                        ...
                        <tr>
                            <td valign="middle" align="center">
                                <p style="font-size: 14px;color:black;font-family: 'Roboto Condensed', sans-serif; margin: 25px 0px 20px;">606 & 607, PURI 81 BUSINESS HUB, Sector 81, Faridabad</p>
                                <p style="font-size: 10px;color:black;font-family: 'Roboto Condensed', sans-serif ;margin: 25px 0px 20px ">© {{ date('Y') }} Thinknyx Technologies LLP. All Rights Reserved</p>
                            </td>
                        </tr>
                    </table>
                </td>
