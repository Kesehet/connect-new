                                                ...
                                                <div class="wizard-inner">
                                                    ...
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        ...
                                                        <li role="presentation" class="{{ (in_array(5, $goalappcombArr) ? 'active' : 'disabled') }}">
                                                            <a href="{{route('appraisal.createorfour')}}" data-toggle="tab"  aria-controls="step5" role="tab"><span class="round-tab">5</span> <i>Goal 5</i></a>
                                                        </li>
                                                    </ul>
                                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="border-top">
                            <div class="card-body" style="float: right;">
                                ...
                                @can('isAdmin')
                                <a class="btn btn-success" type="button" style="float: right; margin-right: 7px;" href="{{route('appraisal.createorthree','uid='.Request::get('uid'))}}"><i class="glyphicon glyphicon-plus"></i> Back</a>
                                @endcan
                                @can('isEmployee')
                                <!--<a class="btn btn-success" type="button" style="float: right; margin-right: 7px;" href="{{route('appraisal.createorthree')}}"><i class="glyphicon glyphicon-plus"></i> Back</a>-->
