                                                ...
                                                <div class="wizard-inner">
                                                    ...
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li role="presentation" class="{{ (in_array(1, $goalappcombArr) ? 'active' : 'disabled') }}">
                                                            <a href="{{route('appraisal.create')}}"  aria-controls="step1" role="tab" aria-expanded="true"><span class="round-tab">1 </span> <i>Goal 1</i></a>
                                                        </li>
                                                        <li role="presentation" class="{{ (in_array(2, $goalappcombArr) ? 'active' : 'disabled') }}" >
                                                            <a href="{{route('appraisal.createorone')}}" aria-controls="step2" role="tab" aria-expanded="false"><span class="round-tab">2</span> <i>Goal 2</i></a>
                                                        </li>
                                                        <li role="presentation" class="{{ (in_array(3, $goalappcombArr) ? 'active' : 'disabled') }}">
                                                            <a href="{{route('appraisal.createortwo')}}" data-toggle="tab" aria-controls="step3" role="tab"><span class="round-tab">3</span> <i>Goal 3</i></a>
                                                        </li>
                ...
                <div class="card">
                    ...
                    <div class="border-top">
                        <div class="card-body" style="float: right;">
                            ...
                            @can('isAdmin')
                            <a class="btn btn-success" type="button" style="float: right;" href="{{route('appraisal.createorthree','uid='.Request::get('uid'))}}"><i class="glyphicon glyphicon-plus"></i> Next</a>
                            <a class="btn btn-success" type="button" style="float: right; margin-right: 7px;" href="{{route('appraisal.createorone','uid='.Request::get('uid'))}}"><i class="glyphicon glyphicon-plus"></i> Back</a>
                            @endcan
                            @can('isEmployee')
                            <!--<a class="btn btn-success" type="button" style="float: right;" href="{{route('appraisal.createorthree')}}"><i class="glyphicon glyphicon-plus"></i> Next</a>
                            <a class="btn btn-success" type="button" style="float: right; margin-right: 7px;" href="{{route('appraisal.createorone')}}"><i class="glyphicon glyphicon-plus"></i> Back</a>-->
