                                                ...
                                                <div class="wizard-inner">
                                                    ...
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li role="presentation" class="{{ (in_array(1, $goalappcombArr) ? 'active' : 'disabled') }}">
                                                            <a href="{{route('appraisal.createfun','uid='.Request::get('uid'))}}" data-toggle="{{ ($goal->order_no == 1 ? 'tab' : '') }}" aria-controls="step1" role="tab" aria-expanded="true"><span class="round-tab">1 </span> <i>Goal 1</i></a>
                                                        </li>
                                                        <li role="presentation" class="{{ (in_array(2, $goalappcombArr) ? 'active' : '') }}" >
                                                            <a href="{{route('appraisal.createfunone','uid='.Request::get('uid'))}}" data-toggle="{{ ($goal->order_no == 2 ? 'tab' : '') }}" aria-controls="step2" role="tab" aria-expanded="false"><span class="round-tab">2</span> <i>Goal 2</i></a>
                                                        </li>
                                                        <li role="presentation" class="{{ (in_array(3, $goalappcombArr) ? 'active' : '') }}">
                                                            <a href="{{route('appraisal.createfuntwo','uid='.Request::get('uid'))}}" data-toggle="{{ ($goal->order_no == 3 ? 'tab' : '') }}" aria-controls="step3" role="tab"><span class="round-tab">3</span> <i>Goal 3</i></a>
                                                        </li>
                                                        <li role="presentation" class="{{ (in_array(4, $goalappcombArr) ? 'active' : '') }}">
                                                            <a href="{{route('appraisal.createfunthree','uid='.Request::get('uid'))}}" data-toggle="{{ ($goal->order_no == 4 ? 'tab' : '') }}" aria-controls="step4" role="tab"><span class="round-tab">4</span> <i>Goal 4</i></a>
                                                        </li>
                                                        <li role="presentation" class="{{ (in_array(5, $goalappcombArr) ? 'active' : '') }}">
                                                            <a href="{{route('appraisal.createfunfour','uid='.Request::get('uid'))}}" data-toggle="{{ ($goal->order_no == 5 ? 'tab' : '') }}" aria-controls="step5" role="tab"><span class="round-tab">5</span> <i>Goal 5</i></a>
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li role="presentation" class="{{ (in_array(1, $goalappcombArr) ? 'active' : 'disabled') }}">
                                                            <a href="{{route('appraisal.createfun')}}" data-toggle="{{ ($goal->order_no == 1 ? 'tab' : '') }}" aria-controls="step1" role="tab" aria-expanded="true"><span class="round-tab">1 </span> <i>Goal 1</i></a>
                                                        </li>
                                                        <li role="presentation" class="{{ (in_array(2, $goalappcombArr) ? 'active' : '') }}" >
                                                            <a href="{{route('appraisal.createfunone')}}" data-toggle="{{ ($goal->order_no == 2 ? 'tab' : '') }}" aria-controls="step2" role="tab" aria-expanded="false"><span class="round-tab">2</span> <i>Goal 2</i></a>
                                                        </li>
                                                        <li role="presentation" class="{{ (in_array(3, $goalappcombArr) ? 'active' : '') }}">
                                                            <a href="{{route('appraisal.createfuntwo')}}" data-toggle="{{ ($goal->order_no == 3 ? 'tab' : '') }}" aria-controls="step3" role="tab"><span class="round-tab">3</span> <i>Goal 3</i></a>
                                                        </li>
                                                        <li role="presentation" class="{{ (in_array(4, $goalappcombArr) ? 'active' : '') }}">
                                                            <a href="{{route('appraisal.createfunthree')}}" data-toggle="{{ ($goal->order_no == 4 ? 'tab' : '') }}" aria-controls="step4" role="tab"><span class="round-tab">4</span> <i>Goal 4</i></a>
                                                        </li>
                                                        <li role="presentation" class="{{ (in_array(5, $goalappcombArr) ? 'active' : '') }}">
                                                            <a href="{{route('appraisal.createfunfour')}}" data-toggle="{{ ($goal->order_no == 5 ? 'tab' : '') }}" aria-controls="step5" role="tab"><span class="round-tab">5</span> <i>Goal 5</i></a>
                                                        </li>
                                                    </ul>
                                                    @endif
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Please review your appraisal before submission. After submission you will not be able to amend it.
                    </div>
