                                                ...
                                                <div class="wizard-inner">
                                                    ...
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        ...
                                                        <li role="presentation" class="{{ (in_array(4, $goalappcombArr) ? 'active' : 'disabled') }}">
                                                            <a href="{{route('appraisal.createfunthree')}}" data-toggle="tab" aria-controls="step4" role="tab"><span class="round-tab">4</span> <i>Goal 4</i></a>
                                                        </li>
                    ...
                    <div class="card">
                        ...
                        <div class="border-top">
                            <div class="card-body" style="float: right;">
                                ...
                                @can('isAdmin')
                                <a class="btn btn-success" type="button" style="float: right;" href="{{route('appraisal.createfunfour','uid='.Request::get('uid'))}}"><i class="glyphicon glyphicon-plus"></i> Next</a>
                                <a class="btn btn-success" type="button" style="float: right; margin-right: 7px;" href="{{route('appraisal.createfuntwo','uid='.Request::get('uid'))}}"><i class="glyphicon glyphicon-plus"></i> Back</a> 
                                @endcan
                                @can('isEmployee')
                                <!--<a class="btn btn-success" type="button" style="float: right;" href="{{route('appraisal.createfunfour')}}"><i class="glyphicon glyphicon-plus"></i> Next</a>
                                <a class="btn btn-success" type="button" style="float: right; margin-right: 7px;" href="{{route('appraisal.createfuntwo')}}"><i class="glyphicon glyphicon-plus"></i> Back</a>-->
