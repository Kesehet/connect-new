    ...
    @endif
        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Professional Development Plan Goal Management</h4>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="card">
                        <form action="{{route('goal.storepd')}}" method="post" class="form-horizontal">
                            @csrf
                            <input type="hidden" name="order_no"  id="order_no" value="{{$goalcnt}}">
                            <div class="card-body">
                                <h4 class="card-title">{{$goalcnt}}.</h4>
