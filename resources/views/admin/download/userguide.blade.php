                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="{{route('download.userguide')}}">User Guide</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row" >
                    <div class="col-md-12">
                        <div class="card">
                             @if ($fileshowflag == 'YES')
                            <embed src="{{ url(asset($user_guide)) }}" style="width:1070px; height:600px;" frameborder="0">
                            @endif
                            @if ($fileshowflag == 'NO')
