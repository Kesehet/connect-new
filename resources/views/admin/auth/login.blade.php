        ...
        <div class="auth-box bg-dark border-top border-secondary">
            <div id="loginform">
                ...
                {{--<form class="form-horizontal m-t-20" id="loginform" action="index.html">--}}
                    <form method="POST" action="{{ route('login') }}" id="theform">
                        @csrf
                            ...
                            <div class="form-group">
                                <div class="p-t-20">
                                    <!--<button class="btn btn-info" id="to-recover" type="button"><i class="fa fa-lock m-r-5"></i> Lost password?</button>-->
                                     ...
                                     <a class="btn btn-info" href="{{ route('password.request') }}" id="to-login" name="action"> <i class="fa fa-lock m-r-5"></i> Reset password?</a>
                                     @endif
...
<script type="text/javascript">
    ...
    $(function(){
     $('form').submit(function(){ 
        ...
        $(":submit", this).text("Please Wait...").attr('disabled', 'disabled');
        return true;
      });
    });
  </script>
